function draw(data) {
    ...
    var myLegend = myChart.addLegend(650, 60, 60, 300, "Right");
    x1.title = "Height in inches";
    y1.title = "Average number of home runs scored";
    ...
    d3.select("#placeholder-2_title")
            .append("h2")
            .text("So, left-handed people have scored most of the home runs.\n\
